    ...
    <footer className="bg-white text-slate-600 mt-24 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 py-16">
          ...
          {/* Products */}
          <div>
            <h4 className="text-slate-900 font-semibold text-sm uppercase tracking-wide mb-6">Products</h4>
          ...
          {/* Legal - Privacy */}
          <div>
            <h4 className="text-slate-900 font-semibold text-sm uppercase tracking-wide mb-6">Privacy</h4>
            <ul className="space-y-3">
              <li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-slate-900 font-semibold text-sm uppercase tracking-wide mb-6">Contact</h4>
            <Link
              to="/get-started"
